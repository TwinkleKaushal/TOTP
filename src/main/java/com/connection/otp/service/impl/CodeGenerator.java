...
import com.connection.otp.service.ICodeGenerator;
...
public class CodeGenerator implements ICodeGenerator {
	...
	public CodeGenerator(HashingAlgorithm algorithm) {
		this(algorithm, 6);
	}
	 ...
	 */
	public byte[] generateHash(String key, long counter) throws InvalidKeyException, NoSuchAlgorithmException {
